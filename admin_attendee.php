...
$sql = 'SELECT s.Registration_No,s.Attendee_No,u.First_Name,u.Last_Name,u.Username,u.Contact_No from myuser u ,attendee s where u.Username=s.username';
...
<body>
  <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans:400,700|Merriweather:700" rel="stylesheet">
<br>
	<h3 style="color:black;"><center><b>Attendees</b></center></h3>
	...
	<table class="data-table">
		...
		{	
			...
			<tr bgcolor="#f4fbff">
					...
					<td><?php echo $row['Attendee_No'] ;$id[$no]=$row['Attendee_No']?></td>
					<td><?php echo $row['First_Name']?></td>
					<td><?php echo $row['Last_Name']?></td>
					<td><?php echo $row['Username']?></td>
					<td><?php echo $row['Contact_No'] ?></td>
					<td><a href="delete.php?id=<?php echo $id[$no]?>">Remove</a></td>
		...
		<tfoot>
			<tr>
				<th colspan="4">Total Attendee</th>
