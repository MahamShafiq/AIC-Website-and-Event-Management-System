...
<body background="img/img2.png">
      <div id="main-wrapper">
	  <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans:400,700|Merriweather:700" rel="stylesheet">
<br>
           		<center>
            <h1 style="color:black;font-family:verdana">Admin's Corner</h1>
			
			For Authenticated AIC Members Use Only!
			<hr>
             <img src="image/admin.jpg" class=".admin"/><br><br>
         </center>

       
             <form class="myform" action="redirectadmin.php" method="post"> <br> <br>
