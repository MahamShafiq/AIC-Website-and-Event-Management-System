...
$q=" SELECT * FROM user_interface where username='$username' ";
mysqli_query($con,$q);
...
<br>
         <center>
            <h2>OOPs!</h2>
             <img src="image/error.jpg" class="DataScience2420x250"/><br>
         </center>

       
             Kindly try different username !either account aleady exist 
			  <form class="myform" action="register.php" method="post"> 
			 
			  <input name="submit_btn" type="submit" id="signup_btn"    value="Back to Sign Up "/><br><br>
		or Already have an account?
			   <a class="login_btn" href="reg_login.php" role="button">Sign in</a>
			   <br><br><br>
			   </form>
	...
	{$sql ="INSERT INTO user_interface(username, password)
			values ('$username', '$password')";
		
mysqli_query($con,$sql);
$sql ="INSERT INTO `myuser` (`User_ID`, `First_Name`, `Last_Name`, `Contact_No`, `CNIC_No`, `Username`, `Institute`, `Department`, `DS_Experience`, `Programming_Experience`) VALUES (NULL, '', '', '', '', '$username', '', '', '', '');";
