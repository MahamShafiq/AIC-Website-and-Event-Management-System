...
<body background="pattern5.jpg">
      <div id="main-wrapper">
	  <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans:400,700|Merriweather:700" rel="stylesheet">
<br>
         <center>
          <h1  style="font-family : verdana ; color:black;">Sign In</h1>
          
             <img src="image/Data Science 2 420x250.png" class="DataScience2420x250"/><br>
         </center>

       
             <form class="myform" action="redirectreg_login.php" method="post"> <br> <br>
               <label>USERNAME: </label><br>
	           <input name="username" type="email" class="inputvalues" placeholder="Type your username" required/><br>
	           <label>PASSWORD:</label><br>
	           <input name="password" type="password" class="inputvalues" placeholder="Type your password" required/><br>
			    
			   <input name="submit_btn" type="submit" id="signup_btn" value="Sign in"/><br>
			   Don't have an account?
			   			   <a class="login_btn" href="register.php" role="button"> Sign up</a>
<br><br>
