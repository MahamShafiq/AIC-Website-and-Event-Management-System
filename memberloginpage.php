...
<h2>Artificial Intelligence Club</h2>
  ...
  <div class="leftcolumn">
	...
	<h2>Welcome Back Dear Member!</h2>
	<img class="d-block img-fluid" src="img/img3.png" alt="sixth" >
...
<form class="myform" action="linklogin.php" method="post"> 
<input name="submit_btn" type="submit" id="signup_btn" value="Register Now"/><br><br><br>
  ...
  <div class="card">
      ...
      <div class="fakeimg1" style="height:600px;"><img src="memberloginimage.png"></div>
	  <p><b>Artificial intelligence club provides it members every possible knowledge and information in the field of AI. Make the most of it. GOOD LUCK !</b></p>
