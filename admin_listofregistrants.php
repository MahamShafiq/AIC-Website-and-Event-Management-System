...
<html>
<head>
	<title>Displaying Account Details</title>
	<style type="text/css">
		body {
			font-size: 15px;
			color: #343d44;
...
<body>
  <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans:400,700|Merriweather:700" rel="stylesheet">
<br>
	<h3 style="color:black;"><center><b>Accounts Details</b></center></h3>
	<caption class="title">following are the Accounts</caption>
	...
	<table class="data-table">
		...
		{	
			...
			<tr bgcolor="#f4fbff">
					...
					<td><?php echo $row['Username'] ;$id[$no]=$row['Username']?></td>
					<td><?php echo $row['Institute'] ?></td>
					<td><?php echo $row['Department'] ?></td>
					<td><?php echo $row['DS_Experience'] ?></td>
					<td><?php echo $row['Programming_Experience'] ?></td>
